...
<header>
    ...
    <div id="switch">
                 ...
                 <span id="userInfo">
                    <i class="iconfont icon-profile-user"></i>
                    <span> 用户 </span>
                </span>
                <span id="exit">
...
<div id="infoBox">
    <div id="info">
        <i class="iconfont icon-close-cross" id="closeInfo"></i>
        <ul>
            账号<li id="accout"></li>
            姓名<li id="name"></li>
            电话<li id="tel"></li>
...
<script>
    document.getElementById("accout").innerHTML = '<%=request.getParameter("accout")%>';
    document.getElementById("name").innerHTML = '<%=request.getParameter("name")%>';
    document.getElementById("tel").innerHTML = '<%=request.getParameter("tel")%>';
</script>
</body>
</html>